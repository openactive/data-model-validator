    ...
    this.meta = {
      ...
      tests: {
        isRpdeFeed: {
          ...
          message: 'The JSON you have submitted appears to be an RPDE feed. Please note that validation on RPDE feeds within the model validator is limited to checking whether required properties are present, and that the data in each item is a valid data model.\n\nPlease also use the [RPDE tab](https://validator.openactive.io/rpde) of this validator to check your RPDE feed is compliant.',
